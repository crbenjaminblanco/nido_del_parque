    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-md-5 mb-4 mb-md-0 d-flex justify-content-center">
          <!-- Instagram iframe -->
          <div class="iframe-instagram" ref="videoContainer">
            <div v-if="!instagramLoaded" class="loading-placeholder">
...
export default {
  ...
  computed: {
    ...
    airbnbUrl() {
      return CONTACT_INFO.AIRBNB_URL
    },
    instagramUrl() {
      return CONTACT_INFO.INSTAGRAM_URL
    },
    bookingUrl() {
      return CONTACT_INFO.BOOKING_URL
    }
  },
  mounted() {
    ...
    // Reprocess Instagram embeds when script loads
    script.onload = () => {
      if (window.instgrm) {
